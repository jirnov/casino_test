...
void Shader::setUniform3f(const std::string& name, const glm::vec3& color) const
{
    glUniform3f(glGetUniformLocation(m_program, name.c_str()), color.x, color.y, color.z);
}
